	...
	const maybeSave = useCallback(() => {
		...
		if(!d || members.length <= 3) {
			...
			const msg = m ?
				"missing description"
			: (
				d ? "needs at least 3 members" : "missing description; needs at least 3 members"
			);
			return toaster({
				message: `Cannot save: ${msg}.`,
				color: "warning",
				position: "middle",
				duration: 5000,
				toast
	...
	return (
		...
		>
			<>
				...
				<IonItem lines="full">
					<IonButton id="addPotentialModifierButton" color="success" slot="end">
